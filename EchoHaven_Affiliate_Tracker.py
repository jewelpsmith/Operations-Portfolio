# Echo Haven Journal - Amazon Affiliate Tracker Generator
# Author: ChatGPT (for Echo Haven Journal)
# Description:
# Generates a pre-filled Excel tracker for managing Amazon Affiliate content,
# links, KPIs, and compliance logs across Pinterest, Instagram, Facebook,
# LinkedIn, and Website (echohavenjournal.com)
...
kpi_dashboard = pd.DataFrame({
    "Metric": [
        "Total Clicks", "Average CTR (%)", "Total Conversions",
        "Total Revenue ($)", "Avg Engagement Goal (%)"
    ],
    "Value": [
...
# === CREATE EXCEL FILE ===
output_path = "EchoHaven_Affiliate_Tracker.xlsx"
...
print(f"✅ Excel tracker successfully created: {output_path}")
